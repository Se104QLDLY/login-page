...
export const RegisterPage: React.FC = () => {
  ...
  const onSubmit = async (data: RegisterCredentials) => {
    try {
      ...
      // Dynamically import register API to avoid circular dependency
      ...
      <div className="w-full max-w-md p-8 bg-white rounded-3xl shadow-2xl border-2 border-cyan-100">
        <div className="flex flex-col items-center mb-8">
          ...
          <p className="text-cyan-700 font-medium">
            Tạo tài khoản đại lý mới để bắt đầu sử dụng hệ thống!
          </p>
        </div>
